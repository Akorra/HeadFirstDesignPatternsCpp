...
std::unique_ptr<GumballMachine> GumballMachine::create(std::string location, int numberGumballs)
{
  std::unique_ptr<GumballMachine> instance(new GumballMachine(location, numberGumballs));
...
{
    std::cout << "Gumball Machine: "   << _machine.getLocation() << std::endl;
    std::cout << "Current Inventory: " << _machine.getCount()    << std::endl;
    std::cout << "Current State: "     << _machine.printState()  << std::endl;
}
